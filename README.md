...
<br><b>Voting</b> - Basic Voting contract. It is not anonymous and the current vote tally can be observed at any time. I believe these problems can be fixed with zk-SNARKs but I don't understand them yet. I will try to extend this to implement a primitive version of Futarchy as I understand it, with it's own token. I expect the token will technically be unnecessary but useful to experiment with.
